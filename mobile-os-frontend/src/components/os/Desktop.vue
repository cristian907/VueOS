          ...
          >
            ...
            >
              ...
              <svg v-else-if="app.iconType === 'svg'" class="w-7 h-7 text-white" :class="app.iconValue === 'notes' || app.iconValue === 'contacts' || app.iconValue === 'phone' ? 'fill-current' : ''" viewBox="0 0 24 24">
                 ...
                 <path v-else-if="app.iconValue === 'youtube'" d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" fill="currentColor"/>
                 <path v-else-if="app.iconValue === 'whatsapp'" d="M12.031 2c-5.508 0-9.972 4.464-9.972 9.972 0 1.764.468 3.42 1.284 4.86L2 22l5.304-1.392c1.404.768 2.988 1.2 4.656 1.2 5.508 0 9.972-4.464 9.972-9.972 0-5.508-4.464-9.972-9.972-9.972zm6.156 14.124c-.252.708-1.464 1.296-2.028 1.368-.516.072-1.188.108-1.92-.132-.48-.156-1.104-.384-1.896-.732-3.372-1.476-5.532-4.896-5.7-5.124-.168-.228-1.38-1.836-1.38-3.504 0-1.668.864-2.496 1.176-2.832.312-.336.684-.42 1.056-.42h.732c.228 0 .432.012.624.048.204.036.432.144.672.72.24.576.816 2.004.888 2.148.072.144.12.312.024.48-.096.168-.144.276-.288.444-.144.168-.312.384-.444.516-.144.132-.3.276-.132.564.168.288.756 1.248 1.62 2.016.924.816 1.704 1.068 2.004 1.2.3.132.48.108.66-.108.18-.216.78-.912.984-1.224.204-.312.408-.264.684-.156.276.108 1.752.828 2.052.984.3.156.492.228.564.36.072.132.072.768-.18 1.476z" fill="currentColor"/>
                 <path v-else-if="app.iconValue === 'instagram'" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.981 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z" fill="currentColor"/>
                 <path v-else-if="app.iconValue === 'facebook'" d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.324v-21.35c0-.732-.593-1.325-1.325-1.325z" fill="currentColor"/>
                 <path v-else-if="app.iconValue === 'tiktok'" d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.06-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.59-1.01-.01 2.62-.02 5.24-.04 7.86-.02 2.04-.54 4.14-1.82 5.76-1.41 1.8-3.71 2.73-5.96 2.51-2.2-.22-4.29-1.6-5.32-3.56-1.08-2.03-.98-4.66.27-6.57 1.21-1.86 3.42-2.94 5.64-2.82.02 1.48.01 2.96.01 4.44-1.12-.13-2.34.18-3.13 1-.84.88-.95 2.27-.37 3.3.51.93 1.56 1.51 2.61 1.52 1.05.01 2.09-.54 2.63-1.44.47-.8.53-1.76.51-2.67.01-4.43.01-8.86.01-13.29z" fill="currentColor"/>
                 <path v-else-if="app.iconValue === 'clock'" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                 <path v-else-if="app.iconValue === 'calendar'" fill="currentColor" d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zM17 12h-5v5h5v-5z"/>
              </svg>
            </DesktopIcon>
          </div>
          <!-- Si el slot está vacío -->
          <div v-else class="w-14 h-14 bg-transparent pointer-events-none">
          </div>
        </div>
      </div>
    </div>
...
const handleOpenApp = (app) => {
  // Si la app tiene una URL, abrir en ventana del navegador
  if (app.url) {
    window.open(app.url, '_blank', 'noopener,noreferrer,width=1000,height=800')
    return
  }
